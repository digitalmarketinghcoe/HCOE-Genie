...
import { DNA_META } from "@/lib/graphify";
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex justify-between items-center mb-1">
          ...
          <span className="text-[0.72rem] font-bold font-mono" style={{ color: meta.color }}>
            {value}%
          </span>
        </div>
    ...
    <div className="flex flex-col gap-4">
      ...
      {archetype && (
        ...
        >
          ...
          <div>
            <div className="text-[0.65rem] font-bold tracking-widest text-white/35 uppercase mb-0.5">
              Your Career DNA Archetype
            </div>
